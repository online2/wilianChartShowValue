...
public class LineCardOne extends CardController {
    ...
    private final float[][] mValues = {{3.5f, 20f, 4.3f, 8f, 6.5f, 9.9f, 7f, 8.3f, 7.0f},
    ...
    public void show(Runnable action) {
        ...
        dataset.setColor(Color.parseColor("#b3b5bb"))
                ...
                .setThickness(4)
                .setEnableDrawValue(true).setValueColor(Color.parseColor("#ffffff"))
                .setValueTextSize(Tools.fromDpToPx(10));
        mChart.addData(dataset);
        ...
        mChart.setAxisBorderValues(0, 20)
                ...
                .setTooltips(mTip)
                .setLabelsFormat(new DecimalFormat("##人"))
