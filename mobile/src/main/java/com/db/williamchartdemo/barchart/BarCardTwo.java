...
public class BarCardTwo extends CardController {
    ...
    private final float[][] mValues = {{0f, 34f, 55f, 71f, 98f}, {-17f, 26f, 48f, -63f, 94f}};
...
//        mChart.setTooltips(tip);
        ...
        for (int i = 0; i < mLabels.length; i++) {
            ...
            barSet.addBar(bar);
            barSet.setGradientColor(new int[]{Color.parseColor("#f7fe96"), Color.parseColor("#fdea11")}, null);
        }
