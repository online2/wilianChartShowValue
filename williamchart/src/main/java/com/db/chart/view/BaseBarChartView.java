...
public abstract class BaseBarChartView extends ChartView {
    ...
    private int DEFAULT_VALUSE_SIZE=8;
    ...
    void calculatePositionOffset(int size) {
        ...
        else drawingOffset = size * barWidth / 2 + ((size - 1) / 2) * mStyle.setSpacing;
    }
    ...
    public class Style {
        ...
        private void init() {
            ...
            valuePaint.setTextSize(Tools.fromDpToPx(DEFAULT_VALUSE_SIZE));
