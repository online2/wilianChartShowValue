...
//            float measureText = mStyle.mValuePaint.measureText(value+".0");
            float textX = mStyle.mValuePaint.measureText(value);
//            Paint.FontMetrics fontMetrics = mStyle.mValuePaint.getFontMetrics();
//            baselineY = dot.getY() + ((fontMetrics.bottom - fontMetrics.top) / 2 - fontMetrics.bottom) - measureText/2-dot.getRadius();
